...
#define STRING_CONFIG_H_AUTHOR "(minego)" // Who made the changes.
...
#define Z_MIN_ENDSTOP_INVERTING false // Z_MIN endstop is our IR Z probe
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 104 }
